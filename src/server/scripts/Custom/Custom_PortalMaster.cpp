...
public:
	...
	bool OnGossipSelect(Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction)
	{
		...
		case GOSSIP_ACTION_INFO_DEF + 201:
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Fun Zone", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 205);
			pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_BATTLE, "Shiney Zone", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 206);
		...
		case GOSSIP_ACTION_INFO_DEF + 205:
			pPlayer->CLOSE_GOSSIP_MENU();
			pPlayer->TeleportTo(530, -252.044998f, 933.021973f, 84.380798f, 1.557000f);
			break;
